...
@Composable
fun SegmentPickerBottomSheetScreenshotTest() {
    SegmentPickerBottomSheetPreview()
}

@PreviewTest
@PreviewForScreenshotTestsDefaultHeight
@Composable
fun SegmentPickerBottomSheetCcrScreenshotTest() {
    SegmentPickerBottomSheetCcrPreview()
}
